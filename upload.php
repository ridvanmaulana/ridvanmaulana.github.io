...
Blog
Help
@ridvanmaulana ridvanmaulana
 
 Watch 3
  Star 10
  Fork 4
wereHamster/ghup
 branch: master  ghup/github-upload.rb
@wereHamsterwereHamster on Nov 5, 2012 Print the github download url instead of the direct link to S3
3 contributors @IQAndreas @wereHamster @jmalak
RawBlameHistory     212 lines (158 sloc)  6.135 kB
#!/usr/bin/env ruby
